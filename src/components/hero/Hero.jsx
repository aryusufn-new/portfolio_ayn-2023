      ...
      <div className=" container mx-auto pt-5 h-[750px] md:h-[100vh] md:flex-col-reverse sm:h-[780px]  flex sm:flex-col-reverse sm:pt-0 ">
        <div className=" left mt-4 md:mt-0 flex-1 flex flex-col justify-center gap-5 w-1/2 md:w-full md:py-2 sm:py-0">
          <div className="info w-fit flex flex-col items-start justify-center gap-3 sm:gap-2">
            ...
            >
              Hello, I'm Ariansyah Yusuf Nurfadhillah
            </h2>
            <TypeAnimation
              data-aos="fade-up"
              sequence={[
          ...
          <div className="icons flex mt-5">
            ...
            >
              ...
              <li>
                <a href="https://www.linkedin.com/in/ariansyah-yusuf-nurfadhillah-55128216b/">
                  {" "}
                  <FaLinkedinIn className=" h-[1.8rem] w-[1.8rem] text-xl hover:scale-125 " />{" "}
                </a>
              </li>
              <li>
                <a href="https://www.instagram.com/yusuf.an18/">
                  {" "}
                  <AiFillInstagram className=" h-[1.8rem] w-[1.8rem] text-xl hover:scale-125  " />{" "}
                </a>
              </li>
              <li>
                <a href="https://api.whatsapp.com/send?phone=6285784608841&text=Halo...Saya%20dari%20....%20Ingin%20bertanya%20tentang%20....">
                  {" "}
        ...
        <div className="right  top-5 flex-1 flex items-center justify-center md:items-end sm:items-end">
          <div className="relative h-[88%] w-fit flex items-center sm:items-end">
            ...
            data-aos="fade-up"
              ...
              src='https://i.postimg.cc/Vv2xVD9G/avatar-transparan.png'
              // src={mine}
              alt="mine"
            />
