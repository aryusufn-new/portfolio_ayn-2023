...
import { IoLogoHtml5, IoLogoCss3, IoMdGitNetwork, IoIosGitNetwork } from "react-icons/io";
...
import { GrAdd, GrCode, GrDomain, GrNetwork, GrSwitch, GrVirtualMachine, GrWifi, GrWifiNone } from "react-icons/gr";
import { SiNextdotjs } from "react-icons/si";
import { FaCpanel, FaNetworkWired, FaPhp, FaReact } from "react-icons/fa";
            ...
            >
              <div className=" flex flex-col gap-6  w-3/4  my-5 md:w-[90%]">
                ...
                <ProgressBar
                  ...
                  value={95}
                />
                <ProgressBar logo={<FaCpanel />} name={"Hosting"} value={80} />
          ...
          <div className="right relative flex-1 flex flex-wrap p-5 gap-10 items-center justify-center sm:w-full">
            ...
            <div className="last2 flex flex-col gap-10">
              ...
              <SkillBox
                className=""
                logo={
                  <SiObsstudio className=" text-white bg-black rounded-full h-fit border-white overflow-hidden" />
                }
                black={"black"}
                white={"white"}
                skill={"Stream OBS"}
